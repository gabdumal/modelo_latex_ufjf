...
%% Este é um exemplo de nota de afazeres nas margens do texto
\todo[author=Gabriel, noinline]{Se houver seção quaternária, incluir texto ...}


%% O título desta vem em caixa baixa
\subsubsubsection{Seção quinária}

%% Este é um exemplo de nota de afazeres no corpo do texto
\todo[author=Gabriel]{Se houver seção quinária, incluir texto ...}
