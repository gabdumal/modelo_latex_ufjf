...
% --- Resumo ---
\newif\ifDefinidaPalavraChaveQuatro{} \DefinidaPalavraChaveQuatrofalse{}
\newif\ifDefinidaPalavraChaveCinco{} \DefinidaPalavraChaveCincofalse{}
...
{%
    ...
    \IfValueTF{#4}
    {\gdef\ValorDaPalavraChaveQuatro{#4} \DefinidaPalavraChaveQuatrotrue}
    {\gdef\ValorDaPalavraChaveQuatro{} \DefinidaPalavraChaveQuatrofalse}
    \IfValueTF{#5}
    {\gdef\ValorDaPalavraChaveCinco{#5} \DefinidaPalavraChaveCincotrue}
    {\gdef\ValorDaPalavraChaveCinco{} \DefinidaPalavraChaveCincofalse}
}
\ExplSyntaxOff%
...
\def\ValorDasPalavrasChave{
    ...
    \ValorDaPalavraChaveTres{}\ifDefinidaPalavraChaveQuatro;
    \ValorDaPalavraChaveQuatro\fi\ifDefinidaPalavraChaveCinco{};
