...
\def\orientador#1#2#3#4{%
    ...
    \gdef\ValorDaInstituicaoDoOrientador{#4}
}
...
\def\coorientador#1#2#3#4{
    ...
    \gdef\ValorDaInstituicaoDoCoorientador{#4}
...
\def\examinadorUm#1#2#3#4{
    ...
    \gdef\ValorDaInstituicaoDoExaminadorUm{#4}
...
\def\examinadorDois#1#2#3#4{
    ...
    \gdef\ValorDaInstituicaoDoExaminadorDois{#4}
...
\def\examinadorTres#1#2#3#4{
    ...
    \gdef\ValorDaInstituicaoDoExaminadorTres{#4}
...
\def\examinadorQuatro#1#2#3#4{
    ...
    \gdef\ValorDaInstituicaoDoExaminadorQuatro{#4}
