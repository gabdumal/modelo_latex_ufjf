...
\begin{folhadeaprovacao}
    ...
    \begin{multicols}{2}
        ...
        %     }
        % \fi
        % \assinatura*{\textbf{\ValorDoNomeCompletoDoExaminadorUmComTitulo{}} \\ Examinador}
        % \assinatura*{\textbf{\ValorDoNomeCompletoDoExaminadorDoisComTitulo{}} \\ Examinador}
        % \assinatura*{\textbf{\ValorDoNomeCompletoDoExaminadorTresComTitulo{}} \\ Examinador}
        % \assinatura*{\textbf{\ValorDoNomeCompletoDoExaminadorQuatroComTitulo{}} \\ Examinador}
    \end{multicols}
