...
\NewDocumentCommand{\inserirFichaCatalografica}{!o}{%
    \DeveGerarFichaCatalograficatrue%
    \IfNoValueF{#1}{\gdef\ConteudoDaFichaCatalografica{#1}}
}

\NewDocumentCommand{\gerarFichaCatalografica}{}
{%
    \begin{fichacatalografica}

        \ifdefined\ConteudoDaFichaCatalografica%
            \ConteudoDaFichaCatalografica%
        \else%
